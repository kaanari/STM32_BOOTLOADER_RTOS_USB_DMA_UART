...
osThreadId USBFileSystemHandle;
osThreadId CommInterfaceHandle;
...
/* USER CODE BEGIN Header_USBFileSystem_Init */
/**
* @brief Function implementing the USBFileSystem thread.
* @param argument: Not used
* @retval None
*/
...
void USBFileSystem_Init(void const * argument)
{
  ...
  /* USER CODE END USBFileSystem_Init */
}

/* USER CODE BEGIN Header_CommInterface_Init */
/**
* @brief Function implementing the CommInterface thread.
* @param argument: Not used
* @retval None
*/
